...
public class Theory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startButtonTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(com.example.javalearnlab.Topic4.Theory.this, com.example.javalearnlab.Topic4.TestsMain.class);
    ...
    private void completionText(){
        ...
        TheorySection[] sections = {
                new TheorySection("topic4_theory_text1_1", null),
                new TheorySection("topic4_theory_text1_2", null),
                new TheorySection("topic4_theory_text1_3", "topic4_theory_code1"),
                new TheorySection("topic4_theory_text1_4", "topic4_theory_code2"),
                new TheorySection("topic4_theory_text2_1", null),
                new TheorySection("topic4_theory_text2_2", "topic4_theory_code3"),
                new TheorySection("topic4_theory_text2_3", "topic4_theory_code4"),
                new TheorySection("topic4_theory_text2_4", "topic4_theory_code5"),
                new TheorySection("topic4_theory_text3_1", null),
                new TheorySection("topic4_theory_text3_2", "topic4_theory_code6"),
                new TheorySection("topic4_theory_text3_3", null)
        };
