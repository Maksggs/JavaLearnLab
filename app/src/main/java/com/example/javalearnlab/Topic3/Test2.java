...
public class Test2 extends Fragment {
    ...
    private void initView(View view) {
        ...
        layout.setText("Командор, чтобы активировать модуль Scanner, его нужно сначала «загрузить» в систему из стандартной библиотеки Java. Какая команда для этого используется?");
        ...
        rb1.setText("include Scanner;");
        rb2.setText("import java.util.Scanner;");
        rb3.setText("connect System.in;");
        rb4.setText("import java.io.Scanner;");
