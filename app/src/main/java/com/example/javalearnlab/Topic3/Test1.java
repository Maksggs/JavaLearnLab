...
public class Test1 extends Fragment {
    ...
    private void initView(View view) {
        ...
        layout.setText("Вам нужно вывести на монитор название текущего сектора и перевести курсор на новую строку для следующего сообщения. Какой метод объекта out вы используете?");
        ...
        rb1.setText("System.out.print()");
        rb2.setText("System.out.println()");
        rb3.setText("System.out.format()");
        rb4.setText("System.out.printf()");
