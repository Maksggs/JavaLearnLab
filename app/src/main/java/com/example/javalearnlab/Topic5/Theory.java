...
public class Theory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        label.setText(R.string.label_topic5);
    ...
    private void completionText(){
        ...
        TheorySection[] sections = {
                new TheorySection("topic5_theory_text1_1", null),
                new TheorySection("topic5_theory_text1_2", null),
                new TheorySection("topic5_theory_text2_1", null),
                new TheorySection("topic5_theory_text2_2", "topic5_theory_code1"),
                new TheorySection("topic5_theory_text3_1", null),
                new TheorySection("topic5_theory_text3_2", "topic5_theory_code2"),
                new TheorySection("topic5_theory_text4_1", null),
                new TheorySection("topic5_theory_text4_2", "topic5_theory_code3"),
                new TheorySection("topic5_theory_text5_1", null),
                new TheorySection("topic5_theory_text5_2", "topic5_theory_code4"),
                new TheorySection("topic5_theory_text6_1", null),
                new TheorySection("topic5_theory_text6_2", "topic5_theory_code5"),
                new TheorySection("topic5_theory_text7_1", null),
                new TheorySection("topic5_theory_text7_2", "topic5_theory_code6"),
                new TheorySection("topic5_theory_text8_1", null),
                new TheorySection("topic5_theory_text8_2", "topic5_theory_code7"),
                new TheorySection("topic5_theory_text9_1", null),
                new TheorySection("topic5_theory_text9_2", "topic5_theory_code8"),
                new TheorySection("topic5_theory_text10_1", null)
        };
