...
public class Test1 extends Fragment {
    ...
    private void initView(View view) {
        ...
        layout.setText("Командор нажимает кнопку «Пуск». Какую именно инструкцию ищет Виртуальная машина Java (JVM), чтобы начать выполнение миссии?");
        ...
        rb1.setText("public void start()");
        rb2.setText("public static void main(String[] args)");
        rb3.setText("public class Program");
        rb4.setText("System.out.println()");
