...
public class Theory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        label.setText(R.string.label_topic8);
        ...
        startButtonTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(com.example.javalearnlab.Topic8.Theory.this, com.example.javalearnlab.Topic8.TestsMain.class);
