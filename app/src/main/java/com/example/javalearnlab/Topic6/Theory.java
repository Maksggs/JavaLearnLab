package com.example.javalearnlab.Topic6;
...
public class Theory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        label.setText(R.string.label_topic6);
        ...
        startButtonTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(com.example.javalearnlab.Topic6.Theory.this, com.example.javalearnlab.Topic6.TestsMain.class);
    ...
    private void completionText(){
        ...
        TheorySection[] sections = {
                new TheorySection("topic6_theory_text1_1", null),
                new TheorySection("topic6_theory_text1_2", null),
                new TheorySection("topic6_theory_text2_1", null),
                new TheorySection("topic6_theory_text2_2", null),
                new TheorySection("topic6_theory_text2_3", null),
                new TheorySection("topic6_theory_text2_4", null),
                new TheorySection("topic6_theory_text2_5", null),
                new TheorySection("topic6_theory_text2_6", null),
                new TheorySection("topic6_theory_text2_7", "topic6_theory_code1"),
                new TheorySection("topic6_theory_text2_8", null),
                new TheorySection("topic6_theory_text2_9", "topic6_theory_code2"),
                new TheorySection("topic6_theory_text3_1", null),
                new TheorySection("topic6_theory_text3_2", null),
                new TheorySection("topic6_theory_text3_3", null),
                new TheorySection("topic6_theory_text3_4", null),
                new TheorySection("topic6_theory_text3_5", null),
                new TheorySection("topic6_theory_text3_6", null),
                new TheorySection("topic6_theory_text3_7", null),
                new TheorySection("topic6_theory_text3_8", "topic6_theory_code3"),
                new TheorySection("topic6_theory_text3_9", null),
                new TheorySection("topic6_theory_text3_10", "topic6_theory_code4")
        };
