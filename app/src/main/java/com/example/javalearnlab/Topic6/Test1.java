...
public class Test1 extends Fragment {
    ...
    private void initView(View view) {
        ...
        layout.setText("Что произойдет в конструкции switch-case, если ни один из блоков case не подошел к значению переменной?");
        ...
        rb1.setText("Программа выдаст ошибку и остановится.");
        rb2.setText("Выполнится код, написанный в блоке default.");
        rb3.setText("Программа автоматически выберет первый case.");
        rb4.setText("Программа пропустит весь switch и пойдет дальше, даже если нет default.");
